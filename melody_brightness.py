...
# This project is converting mel spectogram into clear readable for AI or 
...
class functions:
    ...
    def spectogram(filename, FolderForSpectogram):
        ...
        save_path = '/Users/alex/desktop/' + FolderForSpectogram + '/' + filename
    ...
    def single_file():
        ...
        for file in glob.glob("*.npy"):
            ...
            #   Load first file to use as first array value
            array = np.load('/Users/alex/desktop/files_for_ANN/Alan Walker x David Whistle - Routine_300.npy')
            number = float(300)
...
AI.Type('/Users/alex/desktop/spectogram/','CNN')
