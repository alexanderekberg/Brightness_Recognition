...
def spectogram(filename):
    ...
    y, sr = librosa.load('/Users/alex/desktop/Music Folder/' + filename)
...
def single_file():
    ...
    for file in glob.glob("*.npy"):
        ...
        array = np.load("/Users/alex/desktop/added_brightness/Amaranthe - Exhale_400.npy")
...
os.chdir("/Users/alex/desktop/Music Folder/")
